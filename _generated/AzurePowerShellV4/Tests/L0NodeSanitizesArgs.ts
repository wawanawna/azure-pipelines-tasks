...
// MSRC 129198 (F2): under enforce, a PowerShell statement separator in ScriptArguments must be
// rejected by the Node handler before the `. '<script>' <args>` dot-source sink.
process.env['DISTRIBUTEDTASK_TASKS_ENABLEAZUREPOWERSHELLARGUMENTSSANITIZATION'] = 'true';
